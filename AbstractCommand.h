...
public:
	enum returnvalues { success, failedtocreatefile, failedtoadd, CWDdoesnotexist, notadirectory, directorydoesnotexist,
		filedoesnotexist, fileinuse, listFilesError, CATSpecificationError, dsSpecificationError, directoryNotEmpty, badInput, 
		copyFromDirectory, copyTOiORt, noPath, symToDirectory};
